...
def add_user():
    ...
    if request.method == 'POST':
        ...
        if not email:
            flash('Email name is required!', 'error')
            return render_template('add.html')
        
        if not age:
            flash('Age name is required!', 'error')
            return render_template('add.html')
...
def delete_user(user_id):
    ...
    # TODO: Add success message
    flash('User deleted successfuly!', 'scu')
...
def search_users():
    ...
    query = request.args.get('query', 'success')
